...
# empty_owner_ind <- tapply(owner_data$corp_business_name, owner_data$situs_pID,
...
insist_scrape_owner = purrr:::insistently(scrape_owner,
...
#
owner_data <- foreach(index =length(unique(owner_data$situs_pID)):nrow(target_properties),
                      .options.RNG = 8989,
